...
namespace Roomify.Entities.Migrations
{
    ...
    [Migration("20241230192818_adjustRoomIsAvailable")]
    partial class adjustRoomIsAvailable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Roomify.Entities.Blocker", b =>
                {
                    ...
                    b.Property<int>("BlockerRoomChoiceId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BlockerRoomChoiceId");

                    b.ToTable("Blockers");
                });

            modelBuilder.Entity("Roomify.Entities.BlockerRoomChoice", b =>
                {
                    b.Property<int>("BlockerRoomChoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("BlockerRoomChoiceId"));
                    ...
                    b.HasKey("BlockerRoomChoiceId");

                    b.ToTable("BlockerRoomChoices");
                });
            ...
            modelBuilder.Entity("Roomify.Entities.RoomAffected", b =>
                {
                    b.Property<int>("RoomAffectedId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("RoomAffectedId"));
                    ...
                    b.HasKey("RoomAffectedId");

                    b.HasIndex("BlockerId");

                    b.HasIndex("RoomId");

                    b.ToTable("RoomAffecteds");
                });
            ...
            modelBuilder.Entity("Roomify.Entities.Blocker", b =>
                {
                    b.HasOne("Roomify.Entities.BlockerRoomChoice", "BlockerRoomChoices")
                        .WithMany()
                        .HasForeignKey("BlockerRoomChoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BlockerRoomChoices");
                });
            ...
            modelBuilder.Entity("Roomify.Entities.RoomAffected", b =>
                {
                    b.HasOne("Roomify.Entities.Blocker", "Blockers")
                        .WithMany()
